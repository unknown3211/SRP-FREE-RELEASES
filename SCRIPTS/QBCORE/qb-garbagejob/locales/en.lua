local Translations = {
    ...
    target = {
        ["talk"] = 'Sign In',
        ["grab_garbage"] = "Collect Trash",
        ["dispose_garbage"] = "Throw Trash",
    },
    menu = {
        ["header"] = "Sanitation",
        ["route"] = "Sign In As Garbage",
    ...
    info = {
        ...
        ["all_bags"] = "All garbage bags are collected, proceed to the next location!",
        ...
        ["progressbar"] = "Putting bag in garbage truck ..",
